...
const PrivacyPolicy = () => (
  <React.Fragment>
    ...
    <p>
      Like most website operators, Interface Aesthetics collects
      ...
      Interface Aesthetics's purpose in collecting non-personally identifying
      information is to better understand how Interface Aesthetics's visitors
      use its website. From time to time, Interface Aesthetics may release
      non-personally-identifying information in the aggregate, e.g., by
      publishing a report on trends in the usage of its website.
    </p>
    <p>
      Interface Aesthetics also collects potentially personally-identifying
      information like Internet Protocol (IP) addresses for logged in users and
      for users leaving comments on http://www.interfaceaesthetics.co.uk blog
      posts. Interface Aesthetics only discloses logged in user and commenter IP
      addresses under the same circumstances that it uses and discloses
      personally-identifying information as described below.
    </p>
    <h2>Gathering of Personally-Identifying Information</h2>
    <p>
      Certain visitors to Interface Aesthetics's websites choose to interact
      with Interface Aesthetics in ways that require Interface Aesthetics to
      gather personally-identifying information. The amount and type of
      information that Interface Aesthetics gathers depends on the nature of the
      interaction. For example, we ask visitors who sign up for a blog at
      http://www.interfaceaesthetics.co.uk to provide a username and email
      address.
    </p>
    <h2>Security</h2>
    <p>
    ...
    <p>
      ...
      Privacy Policy covers the use of cookies by Interface Aesthetics and does
    ...
    <p>
      Interface Aesthetics may collect statistics about the behavior of visitors
      to its website. Interface Aesthetics may display this information publicly
      or provide it to others. However, Interface Aesthetics does not disclose
      your personally-identifying information.
    </p>
    <h2>Cookies</h2>
    <p>
      To enrich and perfect your online experience, Interface Aesthetics uses
    ...
    <p>
      ...
      the visitor returns. Interface Aesthetics uses cookies to help Interface
      Aesthetics identify and track visitors, their usage of
      http://www.interfaceaesthetics.co.uk, and their website access
      preferences. Interface Aesthetics visitors who do not wish to have cookies
      placed on their computers should set their browsers to refuse cookies
      before using Interface Aesthetics's websites, with the drawback that
      certain features of Interface Aesthetics's websites may not function
      properly without the aid of cookies.
    </p>
    <p>
      By continuing to navigate our website without changing your cookie
      settings, you hereby acknowledge and agree to Interface Aesthetics's use
      of cookies.
    </p>
    <h2>E-commerce</h2>
    <p>
      Those who engage in transactions with Interface Aesthetics – by purchasing
      Interface Aesthetics's services or products, are asked to provide
      ...
      Interface Aesthetics collects such information only insofar as is
      necessary or appropriate to fulfill the purpose of the visitor's
      interaction with Interface Aesthetics. Interface Aesthetics does not
    ...
    <p>
      Although most changes are likely to be minor, Interface Aesthetics may
      change its Privacy Policy from time to time, and in Interface Aesthetics's
      sole discretion. Interface Aesthetics encourages visitors to frequently
