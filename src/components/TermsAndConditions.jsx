...
const TermsAndConditions = () => (
  <React.Fragment>
    ...
    <p>
      ...
      accordance with and subject to, prevailing law of United Kingdom. Any use
    ...
    <h2>Cookies</h2>
    <p>
      We employ the use of cookies. By using Interface Aesthetics's website you
      consent to the use of cookies in accordance with Interface Aesthetics's
      privacy policy.
    </p>
    <p>
    ...
    <h2>License</h2>
    <p>
      Unless otherwise stated, Interface Aesthetics and/or it's licensors own
      the intellectual property rights for all material on Interface Aesthetics.
      All intellectual property rights are reserved. You may view and/or print
      pages from http://www.interfaceaesthetics.co.uk for your own personal use
      subject to restrictions set in these terms and conditions.
    </p>
    <p>You must not:</p>
    <ol>
      <li>Republish material from http://www.interfaceaesthetics.co.uk</li>
      <li>
        Sell, rent or sub-license material from
        http://www.interfaceaesthetics.co.uk
      </li>
      <li>
    ...
    <p>
      Redistribute content from Interface Aesthetics (unless content is
    ...
    <p>
      ...
      Interface Aesthetics; and (d) where the link is in the context of general
      resource information or is otherwise consistent with editorial content in
    ...
    <p>
      ...
      e-mail to{" "}
      <a
        href="mailto:contact@interfaceaesthetics.co.uk"
        title="send an email to contact@interfaceaesthetics.co.uk"
      >
        contact@interfaceaesthetics.co.uk
      </a>
    ...
    <p>
      No use of Interface Aesthetics's logo or other artwork will be allowed for
