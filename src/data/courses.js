...
const courses = [
  {
    ...
    title: "FOUNDATION COURSE IN Botox ® & DERMAL FILLER",
    price: "£100",
    overview:
    ...
    days: [
      {
        description:
          "Day 1 is devoted to the use of Botox ® to the upper face:",
  ...
  },
  {
    id: 2,
    image: upperFaceBotox,
    title: "ADVANCED COURSE IN Botox ® & DERMAL FILLER",
    price: "£100",
    overview:
    ...
    information: [
      {
        image: "",
        overview: "Advanced Botox ® treatments:",
        details: [
          "Neck – Platysma",
